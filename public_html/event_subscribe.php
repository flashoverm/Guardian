...
?>
	...
	<form
		action="<?= "event_subscribe.php?id=".$event_uuid."&staffid=".$staff_uuid ?>"
		method="post">
		...
		<div class="form-group">
			<label>Löschzug:</label> <select class="form-control" name="engine">
...
<footer>
	<div class="container">
		...
		<?php
		if (isset ( $event_uuid )) {
			echo "<p><a href='event_details.php?id=" . $event_uuid . "' class=\"btn btn-outline-primary\">ZurÃ¼ck</a></p>";
		}
		?>
