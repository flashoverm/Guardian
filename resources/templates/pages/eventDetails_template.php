...
if(strtotime($event->date) >= $now){
    ...
    showInfo("Diese Wache hat bereits stattgefunden, Bearbeitung nicht mehr möglich - <a href='" . $config["urls"]["html"] . "/event_report.php?event=" . $event->uuid . "'>Bericht erstellen</a>");
}
